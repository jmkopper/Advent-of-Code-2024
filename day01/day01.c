...
int main(int argc, char **argv) {
    int* lefts = malloc(sizeof(int) * NUM_LINES);
    int* rights = malloc(sizeof(int) * NUM_LINES);

    read_input(argv[1], lefts, rights);

    int p1 = part1(lefts, rights, NUM_LINES);
    int p2 = part2(lefts, rights, NUM_LINES);
    printf("Part 1: %d\n", p1);
    printf("Part 2: %d\n", p2);
}
